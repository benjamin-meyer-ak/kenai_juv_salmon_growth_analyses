...
We want each sim to be the duration of earliest site visit a consistent end date, and for diet props to be the mean of all sample events for that drainage by spp/age.
...
mean_start_w <- cmax_stats_pct %>%
  # choose whichever weight is earliest observation
  # wrong filter(season == "Early Summer") %>%
  # translate season to number n new column, and slice minimum observation, aw jeah
 ...
 # if there are still multiple sites in the watershed, group/average them
