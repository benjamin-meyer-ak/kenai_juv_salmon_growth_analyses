...
We will group fish growth data at the space/time scale of:
...
[Access final bioenergetics simulation input files here.](https://github.com/benjamin-meyer-ak/kenai_juv_salmon_growth_analyses/tree/main/other/outputs/simulations)
...
static_inputs_dir <- "other/outputs/simulations/static_inputs_master/"
...
Prepare "Initial Settings" file for Fishbioenergetics run, start/end weights for multiple simulations. File prep for format in FB 4.1.1 version 5/15/2018. Fit simulations to final weight.
...
input_csv_dir <- "other/outputs/simulations/sim_size_inputs_FB4.1.csv"
...
Final outcome: a csv for simulation size inputs is stored at
"other/outputs/simulations/", and a folder directory with 5 csv file for each simulation is stored at "other/outputs/simulations/sim_size_inputs_FB4.1.csv".
