...
Update `r Sys.Date()`: we are proceeding with using FB4 1.1.3 software, which uses the "Design File" structure to initiate multiple simulation runs. We will restructure our "Initial Settings" file to match the Design File structure.
...
# copy input files over to FB4 v1.1.3 folder
### not sure how to do this, did it manually for now

design_2015_2016 <- read_excel("other/inputs/diet_size_other/sim_size_inputs_v2.xlsx",sheet = "lw_data") %>%
