...
```{r vals,fig.cap="Dry mass conversion values and energy densities of prey item categories.",echo = F}
...
*Show/Hide Code used prepare revised fish diet data inputs from 2015-2016 observations (e.g. diet data converted to wet mass inputs)*
...
WORKING HERE -- convert code to WET mass
...
Show table of diet proportions -- MAKE THIS JUST DOWNLOADABLE INSTEAD :)

YOU'RE DOING A GREAT JOB!!!

```{r ,fig.cap="Wet mass diet proportions by prey category.",echo = F}

kable(wm_sum_by_event) %>%
  kable_styling(latex_options = "striped") %>%
  kable_styling(latex_options = "scale_down")
```
