...
We used the 2015-2016 observations of diet, water temperature, and fish size as bioenergetics model inputs to generate P - values, or "proportions of maximum consumption" (values range 0 - 1) for fish cohorts in the study (unique stream/species/age). Next, to simulate fish growth under future water temperature conditions, we used observed fish size, P-values, and projected water temperatures to simulate future summer growth.
